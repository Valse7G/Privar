...
// ── Contract addresses ────────────────────────────────────────────────────────
const _c = {
  PrivarShieldVault:         import.meta.env.VITE_SHIELD_VAULT         ?? "0xc05Ba9BF842635d7Bc55434529E0c0337cb72FCa",
  ...
  PrivarStaking:             import.meta.env.VITE_STAKING               ?? "0xAD2F6cF775526F406e11FE3D02Cef5f1c7bafe7d",
  PrivarNullifierRegistry:   import.meta.env.VITE_NULLIFIER_REGISTRY    ?? "0xfbAdD03182934177f74539bFf2460f9da7Fd3CdE",
  PrivarMerkleTreeManager:   import.meta.env.VITE_MERKLE_TREE_MANAGER   ?? "0xcEc7FE67734c35108152e82eA4b95b7618C089b2",
  PrivarDepositManager:      import.meta.env.VITE_DEPOSIT_MANAGER       ?? "0x000Fe68A5F32ff01b5d49fA6F0adAabcb9fbD9BB",
  ...
  PrivarSpendKeyRegistry: import.meta.env.VITE_SPEND_KEY_REGISTRY ?? "0x7b0A32adb0093771B084C9712992F935356C39e8",
  // v5.3.0 — §9.4. Deployed and whitelisted (setBridgeAdapterWhitelist) as
  // part of the same run.
  LiFiBridgeAdapter: import.meta.env.VITE_LIFI_BRIDGE_ADAPTER ?? "0x3C1CC99Ec096AC325e1deE573d29Eeaf55eb932e",
  // §7.5. Deployed 2026-08-25 as part of the v5.3.0 Note Engine suite.
  PrivarNoteRelay: import.meta.env.VITE_NOTE_RELAY ?? "0x5Dc9bb4FC1604f315d638EEb7447BF640CfdfCfF",
  ...
  PrivarCloudVault:    import.meta.env.VITE_CLOUD_VAULT           ?? "0x96d73D155288FdE17EaA164Baf7bf7686c8daa49",
  // LI.FI privacy adapters — redeployed 2026-08-25 as part of the v5.3.0 Note Engine suite.
  LiFiPrivacyAdapter:  import.meta.env.VITE_LIFI_ADAPTER          ?? "0x74cAB299D19d0dC23C3322448f88a84ae9C643E8",
  LiFiPrivacyBridge:   import.meta.env.VITE_LIFI_BRIDGE           ?? "0xC8433982e6704152f9f2d41960f8c377214755c1",
  ...
  XyloNetPrivacyAdapter: import.meta.env.VITE_XYLONET_ADAPTER ?? "0x149761444E70664d77d7DD036947A80C45E5e303",
  ...
  CurvePrivacyAdapter:   import.meta.env.VITE_CURVE_ADAPTER   ?? "0x2D87c6029a401172Df615373E0B93d3D0D480bEc",
